...
@section('main_content')
    ...
    <div class="bg-neutral-900">
        <div class="container max-w-7xl mx-auto py-6 px-6 lg:px-8 md:w-3/4 h-72 flex flex-col justify-center items-center">
            <h1 class="text-white text-3xl md:text-5xl text-center font-extrabold md:leading-[60px] my-6 mx-auto">{{ $sub_category_data->sub_category_name }}</h1>
            <p class="text-neutral-300 text-xl text-center">
                ...
                @else
                {{ count($post_data) }} {{ trans('main_trans.article') }}
                @endif
            </p>
        </div>
    </div>
